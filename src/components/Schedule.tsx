...
const Schedule = () => {
  ...
  const day1: ScheduleItem[] = [
    ...
    { time: '19:30', title: 'Abertura Oficial e Apresentação do Desafio', description: 'Boas-vindas, introdução ao Hackathon e detalhamento do problema real e prático de mercado proposto para o desafio.' },
